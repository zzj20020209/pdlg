...
public interface GoodSmallsortDao {
    //条件查询所有
    public List<GoodSmallsort> queryAllGoodSmallsort(GoodSmallsort goodSmallsort);
    //条件查询所有数量
    public int querycountGoodSmallsort(GoodSmallsort goodSmallsort);
    //添加分类
